  ...
  Future<void> _placeOrder(CartService cartService) async {
    ...
    if (_selectedPaymentMethod == 'UPI') {
      var options = {
        ...
        'prefill': {'contact': '9999999999', 'email': 'test@gemziapp.com'}
      };
      ...
      body: Consumer<CartService>(
        builder: (context, cartService, child) {
          if (cartService.items.isEmpty && !_isLoading) {
            return const Center(
                child:
                    Text("Cart is empty", style: TextStyle(color: textLight)));
          }
                    ...
                    children: [
                      ...
                      AnimatedSize(
                        ...
                        child: _selectedPaymentMethod == 'UPI'
                            ? _buildTextField(_upiIdController,
                                'Enter UPI ID (e.g. mobile@upi)')
                            : Form(
                                key: _formKey,
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    ...
                                    _buildTextField(
                                        _addressController, 'Address Line'),
                                    Row(
                                      children: [
                                        Expanded(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed:
                            _isLoading ? null : () => _placeOrder(cartService),
