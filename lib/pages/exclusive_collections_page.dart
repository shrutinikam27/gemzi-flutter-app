...
class ExclusiveCollectionsPage extends StatelessWidget {
          ...
          List<Map<String, String>> collections = [
            {
              ...
              "desc": "Make your special day more sparkle."
            },
            {
              "name": "Festive Special",
              "image": "assets/auth/ring6.jpeg",
              "desc": "Celebrate moments with high-end gold."
            },
            {
              "name": "Royal Pearl Set",
              "image": "assets/auth/royalpearlset.jpeg",
              "desc": "Elegant pearls for a timeless look."
            },
            {
              "name": "Temple Jewellery",
              "image": "assets/auth/templejhumka.jpeg",
              "desc": "Traditional heritage pieces."
            },
            {
              "name": "Luxury Rings",
              "image": "assets/auth/luxuryring.jpeg",
              "desc": "Exclusive diamond and gold bands."
            },
            {
              "name": "Classic Bangles",
              "image": "assets/auth/bangles.jpeg",
              "desc": "Traditional gold bangles collection."
            },
            {
              "name": "Diamond Studs",
              "image": "assets/auth/crystalstuds.jpeg",
              "desc": "Sparkle every day with diamond studs."
            },
          ];
          ...
          if (Responsive.isMobile(context)) {
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildCollectionCard(context, collections[index], index);
              },
            );
          } else {
  ...
  Widget _buildCollectionCard(
      BuildContext context, Map<String, String> col, int index) {
    return FadeInUp(
