...
class _CartPageState extends State<CartPage> {
                ...
                desktop: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                          width: 400,
                          child: _buildCartSummary(cartService, isDesktop: true)),
                    ],
                  ),
                ),
              );
  ...
  Widget _buildCartSummary(CartService cartService, {bool isDesktop = false}) {
    const Color surfaceDark = Color(0xFF17453F);
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: isDesktop
            ? Border.all(color: richGold.withValues(alpha: 0.2))
            : null,
      ),
      child: Column(
        mainAxisSize: MainAxisSize.min,
          ...
          Row(
            ...
            children: [
              ...
              Text('${cartService.totalQuantity}',
                  style: const TextStyle(color: richGold, fontSize: 16)),
            ],
          ),
